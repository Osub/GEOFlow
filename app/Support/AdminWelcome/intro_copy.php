...
return [
    'zh-CN' => [
        ...
        'letter' => [
            'title' => '欢迎使用 '.$brand,
            'subtitle' => '你好，欢迎来到 '.$brand.'。',
            'blocks' => [
                [
                    'type' => 'paragraph',
                    'content' => '如果你现在正在看这个页面，说明你已经进入了 '.$brand.' 的管理后台。先不用急着点功能，我想先用一封简短的见面信，告诉你这套系统是做什么的，它适合什么样的工作，以及我接下来还会把它继续往哪里推进。',
                ],
                [
                    'type' => 'paragraph',
                    'content' => $brand.' 不是一个简单的 CMS，也不只是一个 AI 写作工具。它更像一套围绕 GEO 工程设计构建的内容操作系统：把模型配置、素材管理、任务调度、内容生成、审核发布、前台展示，以及 Skill、CLI、API 协作能力，串成一条完整的工作链路。',
                ],
                [
                    'type' => 'heading',
                    'content' => '你可以用 '.$brand.' 做什么',
                ],
                [
                    'type' => 'list',
                    'items' => [
                ...
                [
                    'type' => 'paragraph',
                    'content' => $brand.' 的出发点不是页面管理，而是内容工程。我更关注的是：一套系统能不能把任务、素材、模型、提示词、审核、发布和前台展示统一起来，并且真正适配 AI 搜索和生成式引擎的内容需求。',
                ],
                [
                    'type' => 'paragraph',
    ...
    'en' => [
        ...
        'letter' => [
            ...
            'subtitle' => 'Hi, welcome to '.$brand.'.',
            'blocks' => [
                [
                    'type' => 'paragraph',
                    'content' => 'If you are seeing this page, you have already entered the '.$brand.' admin. Before you start clicking around, I want to use a short welcome letter to explain what this system is for, what kinds of work it fits, and where I am taking it next.',
                ],
                [
                    'type' => 'paragraph',
                    'content' => $brand.' is not just a CMS, and it is not just an AI writing tool. It is closer to a content operating system built around GEO engineering: model setup, asset management, task scheduling, content generation, review, publishing, frontend delivery, and Skill / CLI / API collaboration in one workflow.',
                ],
                [
                    'type' => 'heading',
                    'content' => 'What you can do with '.$brand,
                ],
                [
                    'type' => 'list',
                    'items' => [
                ...
                [
                    'type' => 'paragraph',
                    'content' => $brand.' starts from content engineering rather than page management. The goal is to make tasks, assets, models, prompts, review, publishing, and frontend delivery work together in one system, and to align that system with the real needs of AI search and generative engines.',
                ],
                [
                    'type' => 'paragraph',
